// Provided by:   ________Matheus Figueroa__________
...
namespace main_savitch_2C
{
    ...
    private:
        int    m_len;	// length of sequence (# entries in sequence)
        double m_sum;	// sum of all the numbers in the sequence
        double m_min;	// smallest number in the sequence
        double m_max;	// largest  number in the sequence
    };
